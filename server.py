    ...
    'Denmark': [
        {
            ...
            "bio": "Danish filmmaker Thomas Vinterberg (b. 1969) co-founded Dogme 95 alongside Lars von Trier. Celebrated for films like Festen (The Celebration, 1998) and the award-winning Another Round (2020), his directorial style is marked by emotional intensity, intimate camera work, and compelling explorations of family dynamics, societal pressures, and human vulnerability.",
            "filmography": [
                "Festen (1998)",
                "Submarino (2010)",
                "The Hunt (2012)",
        ...
        },
        {
            ...
            "bio": "Danish filmmaker Lars von Trier (b. 1956) co-founded the Dogme 95 movement, advocating minimalistic, realistic filmmaking, rejecting elaborate special effects and promoting authenticity. Known for his provocative style and experimental narratives, his notable films include Breaking the Waves, Dogville, and the controversial Antichrist, consistently challenging cinematic conventions.",
            "filmography": [
        ...
        },
        {
            ...
            "bio": "Danish director Søren Kragh-Jacobsen (b. 1947) emerged prominently with his contributions to the Dogme 95 movement, notably Mifune’s Last Song (1999). His style emphasizes nuanced human relationships, combining sensitivity with social realism, and highlighting character-driven storytelling without artificial cinematic techniques.",
            "filmography": [
    ...
    'USA': [
        {
            ...
            "bio": "American filmmaker Harmony Korine (b. 1973) gained recognition for his provocative and experimental approach, often exploring marginalized, eccentric characters. His films, including Gummo (1997) and Julien Donkey-Boy (1999), showcase chaotic narratives, raw visuals, and confrontational realism, earning him a reputation as an auteur of avant-garde cinema.",
            "filmography": [
                "Gummo (1997)",
        ...
        },
        {
            ...
            "bio": "American director James Merendino (b. 1969) is best known for his energetic and subculture-focused style, exemplified by his cult film SLC Punk! (1998), which became influential among indie cinema enthusiasts. His work frequently blends dark humor with youthful rebellion, characterized by raw aesthetics and vibrant storytelling.",
            "filmography": [
                "Beware of Dog (1993)",
                "Hard Drive (1994)",
...
QUIZ = {
    ...
    5: {
        ...
        "img": "https://media.senscritique.com/media/000006321430/375x230/amerikana.jpg",
    ...
    6: {
        "prompt": "Which Dogme 95 Film Is This?",
        "img": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTieTxFLEl-qtSEilaQ_H0YbE-h4VUx1WIZ6w&s",
        "options": ["The Idiots","Julien Donkey-Boy","Festen","Amerikana"],
        "answer": "The Idiots",
        "multi": False
    },
...
def rule_detail(rule_id):
    ...
    return render_template('rule_detail.html', rule=rule, rule_id=rule_id, prev_id=prev_id, next_id=next_id)
...
def film_detail(country, dir_id, film_idx):
    ...
    directors_list = DIRECTORS.get(key, [])
    director = next((d for d in directors_list if d['id'] == dir_id), None)
    if not director or film_idx < 0 or film_idx >= len(director['dogme_films']):
        abort(404)

    film_title = director['dogme_films'][film_idx]
...
def quiz_result():
    ...
    for qid, resp in answers.items():
        ...
        if isinstance(correct, list):
            ...
            score += (resp==correct)
    saved = session.get('saved_movies', [])
    return render_template('quiz_result.html', score=score, total=len(QUIZ), saved=saved)
